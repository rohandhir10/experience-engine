...
// A hardcoded example so /s/demo renders the full result screen without a
// live engine behind it — useful for previews (design reviews, deployed
// checks) where no hosted Python backend exists yet. Not used by the real
// flow at all; app/api/adapt/route.ts never reads this file.
export const demoResult: ExperienceResult = {
  id: "demo",
  hook:
