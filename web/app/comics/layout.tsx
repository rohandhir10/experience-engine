...
export const metadata: Metadata = {
  ...
  description:
    "Upload comic or webtoon panels. Castia OCRs each bubble, adapts the dialogue through the same Writers' Room pipeline as its music tool, and can redraw the panel with the adapted text typeset in. Beta: no save/collections yet.",
