...
export function YoutubeImportField({
  ...
  const fieldClass = dark
    ...
    : "border-black/[0.08] bg-white/70 text-ink placeholder:text-ink/30 focus:border-black/20 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-ink-dark dark:placeholder:text-ink-dark/30";
