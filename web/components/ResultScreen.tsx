  ...
  return (
    <main className="min-h-screen px-6 pb-28 pt-8 sm:px-10">
      <div className="mx-auto flex max-w-3xl items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          <button
            ...
            className="flex items-center gap-2 text-[13px] text-ink/45 transition hover:text-ink/70 dark:text-ink-dark/45 dark:hover:text-ink-dark/70"
          >
            <span
            ...
            >
              <span
                className={`absolute top-[2px] h-[14px] w-[14px] rounded-full bg-white transition-transform dark:bg-paper-dark ${
      ...
      <div className="mx-auto mt-16 max-w-2xl text-center sm:mt-24">
        <p className="animate-fade-up font-serif text-[1.7rem] leading-[1.4] tracking-tight text-ink dark:text-ink-dark sm:text-[2.05rem]">
          {result.hook}
        </p>
      </div>

      <div className="mx-auto mt-20 flex max-w-2xl flex-col gap-8 sm:mt-24">
