...
AGENT_BRIEFS: dict[str, str] = {
    ...
    "creative_adapter": (
        ...
        "you may each state once. The same applies to a rhetorical "
        "question: it stays a question, it does not get flattened into a "
        "statement.\n"
...
def _judge_gates_and_dimensions(target_language: str) -> str:
    ...
    "stanza, a rhetorical question, a working image) OR "
